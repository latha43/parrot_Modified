...
short_description: Module to manage user creation in bitbucket

version_added: "2.4"

description:
    - "Module to manage user creation in bitbucket"
...
def run_module():
    ...
    try:
        pwd = BitBucket.password_gen()
        res, msg = BitBucket.add_user(name, pwd, display_name, email_address)
        if res == BBApi.EXISTS:
